...
def build_config_tabview(self):
    ...
    self.ai_config_tab = self.config_tabview.add("模型配置")
    self.embeddings_config_tab = self.config_tabview.add("向量配置")
    self.config_choose = self.config_tabview.add("流程模型选择")
